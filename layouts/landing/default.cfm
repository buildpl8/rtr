  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="header-navbar">
      <ul class="nav navbar-nav navbar-end">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#about" data-click="scroll-to-target">What is it?</a>
        </li>
     
        <li class="nav-item">
          <a class="nav-link" href="#work" data-click="scroll-to-target">Examples</a>
        </li>
        ...
        <li class="nav-item">
          ...
          <a class="nav-link" href="#pricing" data-click="scroll-to-target"><button class="btn btn-sm btn-success">Lets Get Started!</button></a>
        </li>
        <li class="nav-item">
