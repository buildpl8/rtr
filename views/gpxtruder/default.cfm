...
<html lang="en">
	<head>
		...
		<link rel="apple-touch-icon" sizes="152x152" href="http://gpxtruder.xyz/img/apple-touch-icon-152-152.png">
	...
	<body onLoad="setup();">
		...
		<div id="intro" class="panel">
			<p><img src="http://gpxtruder.xyz/img/title.png" alt="GPXtruder: Make 3D-printable models of GPX tracks" /></p>
			<table id="howto">
				<tr>
					<td>
						<p><img src="http://gpxtruder.xyz/img/step1.png" alt="Step 1" /></p>
					...
					<td>
						<p><img src="http://gpxtruder.xyz/img/step2.png" alt="Step 2" /></p>
					...
					<td>
						<p><img src="http://gpxtruder.xyz/img/step3.png" alt="Step 3" /></p>
		...
		<div id="input" class="panel">
			<p class="iolabel"><img src="http://gpxtruder.xyz/img/input.png" width="129" height="31" alt="Input" /></p>
		...
		<div id="output" class="panel">
			<p class="iolabel"><img src=http://gpxtruder.xyz/output.png" width="166" height="31" alt="Output" /></p>
			<div id="display"></div>
			<details>
